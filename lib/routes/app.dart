...
final appRouter = AppRouter()
  ..route('/', 'home', (state) => HomeController().homeView()) 
  ..route('/login', 'login', (state) => AuthController().loginView())
  ..route('/forgot-password', 'forgotPassword', (state) => AuthController().forgotPassView());